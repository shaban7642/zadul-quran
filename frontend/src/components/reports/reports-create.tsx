...
const CreateReport: FC<CreateReportProps> = (props) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values: any) => {
            try {
                const { id, success } = await createReport(values);
                // Update URL query with sub=true
                router.push(
                    {
                        pathname: router.pathname,
                        query: { ...router.query, sub: "true" },
                    },
                    undefined,
                    { shallow: true }
                );
    ...
    const createReport = async (
        ...
        try {
            const { id } = await reportApi.createReport(values);
    ...
    const createDocument = async (
        ...
        try {
            ...
            setDocumentId([...documentId, doc.id]);
            return { success: true };
        } catch (err: any) {
            console.log(err);
            return { success: false };
    ...
    const uploadFile = async (e: any) => {
        ...
        try {
            ...
            const uploadResp = await createDocument(
                formData,
                user.id,
                reportId
            );
                        ...
                        <Grid item xs={12}>
                            ...
                            >
                                ...
                                {sessionDeptName === "Arabic" && (
                                    <>
                                        ...
                                        <TextField
                                            ...
                                            error={Boolean(
                                                formik.touched.newWords &&
                                                    formik.errors.newWords
                                            )}
                                            // @ts-ignore
                                            helperText={
                                                formik.touched.newWords &&
                                        ...
                                        <TextField
                                            ...
                                            error={Boolean(
                                                formik.touched.expressions &&
                                                    formik.errors.expressions
                                            )}
                                            // @ts-ignore
                                            helperText={
                                                formik.touched.expressions &&
                                ...
                                {sessionDeptName === "Quran" && (
                                    <>
                                        ...
                                        <TextField
                                            ...
                                            error={Boolean(
                                                formik.touched.memorization &&
                                                    formik.errors.memorization
                                            )}
                                            // @ts-ignore
                                            helperText={
                                                formik.touched.memorization &&
                                        ...
                                        <TextField
                                            ...
                                            error={Boolean(
                                                formik.touched.tajweed &&
                                                    formik.errors.tajweed
                                            )}
                                            // @ts-ignore
                                            helperText={
                                                formik.touched.tajweed &&
                                        ...
                                        <TextField
                                            ...
                                            error={Boolean(
                                                formik.touched.recitation &&
                                                    formik.errors.recitation
                                            )}
                                            // @ts-ignore
                                            helperText={
                                                formik.touched.recitation &&
                                ...
                                <TextField
                                    ...
                                    required
                                    error={Boolean(
                                        formik.touched.homework &&
                                            formik.errors.homework
                                    )}
                                    // @ts-ignore
                                    helperText={
                                        formik.touched.homework &&
