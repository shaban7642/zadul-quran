...
export const SessionsTable: FC<SessionsTableProps> = (props) => {
  ...
  const tabs: any[] = [
    ...
    },
    {
      label: "waiting",
      value: "waiting",
      count: statusCount.find((item) => item.status.match("waiting"))?.count,
    },
    {
      label: "running",
      value: "running",
      count: statusCount.find((item) => item.status.match("running"))?.count,
    },
    {
      label: "done",
      value: "done",
    ...
    },
    {
      label: "cancelled",
      value: "cancelled",
      count: statusCount.find((item) => item.status.match("cancelled"))?.count,
    },
    {
      label: "expired",
      value: "expired",
      count: statusCount.find((item) => item.status.match("expired"))?.count,
    },
    {
      label: "absent",
      value: "absent",
      count: statusCount.find((item) => item.status.match("absent"))?.count,
    },
    {
      label: "rescheduled",
      value: "rescheduled",
  ...
  const applyFilters = (comingFilters: any): any => {
    console.log({ object: comingFilters });
